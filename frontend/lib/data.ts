...
export const TRACKER_DATA: Record<string, Row[]> = {
  ...
  DIXON: [
    r("FY22",  11679.0,  null,    0.016,    186.9,  null,      null,      59.3,   3970.0),
    r("FY23",  13283.0,  0.137,   0.015,    199.2,  null,      null,      59.3,   6161.0),
    r("FY24",  27021.0,  1.034,   0.017,    459.4,  170.0,  78000.0,     59.3,   13159.0),
    r("FY25",  58770.0,  1.175,   0.018,   1057.9,  130.0, 137500.0,     59.3,   23186.0),
    r("FY26",  48873.0,  -0.168,   0.034,   1644.0,   59.0,  97159.0,     69.5,   9673.0),
