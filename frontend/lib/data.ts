...
export const PORTFOLIO: Record<string, { qty: number; avg_cost: number; prev_close: number | null }> = {
  ...
  BHARTIARTL: { qty: 1, avg_cost: 1837,   prev_close: 1072  },
  CCAVENUE:   { qty: 1, avg_cost: 18,     prev_close: 14    },
  CDSL:       { qty: 1, avg_cost: 1254,   prev_close: null  },
  COFORGE:    { qty: 1, avg_cost: 1130,   prev_close: null  },
  DIXON:      { qty: 1, avg_cost: 15430,  prev_close: 22840 },
  ETERNAL:    { qty: 1, avg_cost: 95,     prev_close: 203   },
  GOLDBEES:   { qty: 1, avg_cost: 125.54, prev_close: null  },
  IDFCFIRSTB: { qty: 1, avg_cost: 77.25,  prev_close: null  },
  ...
  POLICYBZR:  { qty: 1, avg_cost: 1560,   prev_close: 1742  },
  RELIANCE:   { qty: 1, avg_cost: 1350,   prev_close: 2375  },
  TECHD:      { qty: 1, avg_cost: 525,    prev_close: null  },
  VBL:        { qty: 1, avg_cost: 525,    prev_close: null  },
  WAAREEENER: { qty: 1, avg_cost: 2676,   prev_close: 3160  },
  WAAREERTL:  { qty: 1, avg_cost: 1130,   prev_close: null  },
};
...
export const TRACKER_DATA: Record<string, Row[]> = {
  ...
  CCAVENUE: [
    ...
    r("FY26",  8116.0,  1.032,   0.036,  295.0,  17.5,  5162.0,  368.75,  14.0),
  ],
  BHARTIARTL: [
  ...
  JWL: [
    ...
    r("FY26",  2916.0, -0.264,   0.072,  210.0,  56.0, 11761.0,  42.70,  278.0),
  ],
  TECHD: [
  ...
  VBL: [
    ...
    r("FY26", 22693.0,  0.046,   0.141, 3200.0,  56.0,178343.0, 341.0,  523.0),
  ],
  WAAREERTL: [
