...
export const COMPANY_META: Record<string, { name: string; sector: string; multiple_type: string }> = {
  ...
  CCAVENUE:   { name: "AvenuesAI",              sector: "Fintech / Payment Gateway",  multiple_type: "P/E" },
  ...
  TECHD:      { name: "TechD Cybersecurity",     sector: "Cybersecurity",              multiple_type: "P/E" },
...
// prev_close = closing price on March 30, 2026 (last trading day of FY26;
// March 31 was a holiday for Mahavir Jayanti). Source: stockanalysis.com / screener.in
export const PORTFOLIO: Record<string, { qty: number; avg_cost: number; prev_close: number | null }> = {
  ...
  BHARTIARTL: { qty: 1, avg_cost: 1837,   prev_close: 1782  },
  CCAVENUE:   { qty: 1, avg_cost: 18,     prev_close: 13    },
  CDSL:       { qty: 1, avg_cost: 1254,   prev_close: 1119  },
  COFORGE:    { qty: 1, avg_cost: 1130,   prev_close: 1115  },
  DIXON:      { qty: 1, avg_cost: 15430,  prev_close: 9673  },
  ETERNAL:    { qty: 1, avg_cost: 95,     prev_close: 229   },
  GOLDBEES:   { qty: 1, avg_cost: 125.54, prev_close: 121   },
  IDFCFIRSTB: { qty: 1, avg_cost: 77.25,  prev_close: 59    },
  IREDA:      { qty: 1, avg_cost: 164.25, prev_close: 109   },
  JWL:        { qty: 1, avg_cost: 401.11, prev_close: 238   },
  KAYNES:     { qty: 1, avg_cost: 4015,   prev_close: 3430  },
  MEDANTA:    { qty: 1, avg_cost: 1200,   prev_close: 961   },
  "M&M":      { qty: 1, avg_cost: 3358,   prev_close: 2955  },
  MAZDOCK:    { qty: 1, avg_cost: 2454,   prev_close: 2065  },
  MON100:     { qty: 1, avg_cost: 223,    prev_close: 232   },
  NIFTYBEES:  { qty: 1, avg_cost: 200,    prev_close: 253   },
  POLICYBZR:  { qty: 1, avg_cost: 1560,   prev_close: 1428  },
  RELIANCE:   { qty: 1, avg_cost: 1350,   prev_close: 1344  },
  TECHD:      { qty: 1, avg_cost: 525,    prev_close: 433   },
  VBL:        { qty: 1, avg_cost: 525,    prev_close: 384   },
  WAAREEENER: { qty: 1, avg_cost: 2676,   prev_close: 3110  },
  WAAREERTL:  { qty: 1, avg_cost: 1130,   prev_close: 782   },
};
...
export const TRACKER_DATA: Record<string, Row[]> = {
  POLICYBZR: [
    ...
    r("FY26",  6794.0,   0.365,     0.099,   670.0,    99.0,  66116.0,       46.3,  1428.0),
  ...
  ETERNAL: [
    ...
    r("FY26",  54364.0,   1.687,    0.0067,   366.0,  575.0, 210600.0,      919.0,   229.0),
  ...
  DIXON: [
    r("FY22",  11679.0,  null,    0.016,    186.9,  null,      null,      5.91,   3970.0),
    r("FY23",  13283.0,  0.137,   0.015,    199.2,  null,      null,      5.93,   6161.0),
    r("FY24",  27021.0,  1.034,   0.017,    459.4,  170.0,  78000.0,     6.11,   13159.0),
    r("FY25",  58770.0,  1.175,   0.018,   1057.9,  130.0, 137500.0,     6.78,   23186.0),
    r("FY26",  48873.0,  -0.168,   0.034,   1644.0,   41.0,  67227.0,     6.95,   9673.0),
    r("FY27E",176310.0,  0.50,    0.022,   3878.8,   60.0, 232700.0,     6.95,   39240.0),
    r("FY28E",246834.0,  0.40,    0.024,   5924.0,   50.0, 296200.0,     6.95,   49950.0),
    r("FY29E",326022.5,  0.32,    0.026,   8476.6,   40.0, 339100.0,     6.95,   57200.0),
    r("FY30E",399847.3,  0.23,    0.028,  11195.7,   35.0, 391800.0,     6.95,   66080.0),
    r("FY31E",479816.8,  0.20,    0.030,  14394.5,   30.0, 431800.0,     6.95,   72850.0),
  ],
  RELIANCE: [
    ...
    r("FY26", 1055780.0, 0.117,  0.091,  95754.0,  18.0,1747050.0,   6763.0,    1344.0),
  ...
  CCAVENUE: [
    r("FY20",   633.0,   null,   0.171,  108.0,  null,    null,  337.5,    null),
    r("FY21",   676.0,  0.068,   0.104,   70.0,  null,    null,  318.2,    null),
    r("FY22",  1294.0,  0.915,   0.065,   84.0,  null,    null,  323.1,    null),
    r("FY23",  1962.0,  0.516,   0.069,  136.0,  null,    null,  323.8,    null),
    r("FY24",  3150.0,  0.606,   0.050,  156.0,  null,    null,  346.7,    null),
    r("FY25",  3993.0,  0.268,   0.059,  236.0,  null,    null,  363.1,    null),
    r("FY26",  8116.0,  1.032,   0.036,  295.0,  16.6,  4934.0,  368.75,  13.40),
  ],
  BHARTIARTL: [
    r("FY20", 104461.0,  0.05,   0.022,   2294.4,  null,    null,   5540.0,    433.0),
    r("FY21", 104522.0,  0.001,  0.050,   5226.1,  null,    null,   5500.0,    542.0),
    r("FY22", 116547.0,  0.115,  0.079,   9204.8,  null,    null,   5700.0,    742.0),
    r("FY23", 139145.0,  0.194,  0.098,  13636.2,  null,    null,   5690.0,    799.0),
    ...
    r("FY26",  210973.0,  0.244,  0.160,  33823.0,  30.0,1014258.0, 5690.0,    1782.0),
  ...
  MAZDOCK: [
    ...
    r("FY26",  12840.0,   0.146,  0.190,  2436.0,   34.0,  83243.0,  403.3,    2065.0),
  ...
  WAAREEENER: [
    ...
    r("FY26",  26537.0,   0.846,  0.146,  3884.0,   23.0,  89571.0,   30.08,    3110.0),
  ...
  KAYNES: [
    ...
    r("FY26",  3626.0,   0.577,  0.100,   364.0,   64.0,  23381.0,    6.7,     3430.0),
  ...
  "M&M": [
    r("FY20",  48573.0,  0.04,   0.050,   2428.7,  null,    null,   1240.0,    285.0),
    r("FY21",  47354.0, -0.025,  0.040,   1894.2,  null,    null,   1240.0,    436.0),
    r("FY22",  60086.0,  0.269,  0.060,   3605.2,  null,    null,   1240.0,    807.0),
    r("FY23",  97608.0,  0.625,  0.080,   7808.6,  null,    null,   1240.0,   1159.0),
    ...
    r("FY26",  198639.0,  0.315,  0.094,  18622.0,  20.0, 366383.0, 1240.0,   2955.0),
  ...
  IREDA: [
    ...
    r("FY26",   8309.0,  0.013,  0.225,   1873.0,  16.0,  30558.0, 2809.0,    109.0),
  ...
  CDSL: [
    ...
    r("FY21",  344.0,  0.529,   0.584,  201.0,  null,    null,  20.96,    107.0),
    r("FY22",  551.0,  0.602,   0.566,  312.0,  null,    null,  20.96,    312.0),
    r("FY23",  555.0,  0.007,   0.497,  276.0,  null,    null,  20.91,    403.0),
    r("FY24",  812.0,  0.463,   0.517,  420.0,  null,    null,  20.95,    947.0),
    r("FY25", 1082.0,  0.333,   0.486,  526.0,  null,    null,  20.86,   1435.0),
    r("FY26", 1145.0,  0.058,   0.397,  455.0,  51.0, 23336.0,  20.85, 1119.0),
  ],
  COFORGE: [
    r("FY20",  4184.0,   null,   0.112,  468.0,  null,    null,  32.93,    null),
    r("FY21",  4663.0,  0.114,   0.100,  466.0,  null,    null,  30.98,    230.0),
    r("FY22",  6432.0,  0.380,   0.111,  715.0,  null,    null,  32.91,    385.0),
    r("FY23",  8015.0,  0.246,   0.093,  745.0,  null,    null,  32.79,    892.0),
    r("FY24",  9009.0,  0.124,   0.093,  836.0,  null,    null,  31.98,   1092.0),
    r("FY25", 12051.0,  0.338,   0.078,  936.0,  null,    null,  38.54,   1737.0),
    r("FY26", 16403.0,  0.361,   0.106, 1745.0,  24.0, 41980.0,  37.65, 1115.0),
  ],
  IDFCFIRSTB: [
    r("FY20", 16240.0,   null,  -0.175, -2843.0,  null,    null,  481.0,    null),
    r("FY21", 15968.0, -0.017,   0.030,   483.0,  null,    null,  568.0,     21.0),
    r("FY22", 17173.0,  0.075,   0.008,   132.0,  null,    null,  629.0,     38.0),
    r("FY23", 22728.0,  0.323,   0.109,  2485.0,  null,    null,  663.0,     61.0),
    r("FY24", 30325.0,  0.334,   0.097,  2942.0,  null,    null,  707.0,     55.0),
    r("FY25", 36502.0,  0.204,   0.041,  1490.0,  null,    null,  730.0,     82.0),
    r("FY26", 40549.0,  0.111,   0.040,  1611.0,  32.0, 50808.0,  861.5,   58.85),
  ],
  JWL: [
    ...
    r("FY24",  3641.0,  0.761,   0.091,  333.0,  null,    null,  41.30,    374.0),
    r("FY25",  3963.0,  0.088,   0.096,  380.0,  null,    null,  42.40,    408.0),
    r("FY26",  2916.0, -0.264,   0.072,  210.0,  48.0, 10163.0,  42.70,  238.0),
  ],
  TECHD: [
    ...
    r("FY26",   52.0,  0.733,   0.269,   14.0,  22.0,  308.0,  0.748,  433.0),
  ],
  VBL: [
    r("FY20",  6450.0,   null,   0.055,  357.0,  null,    null, 353.5,    null),
    r("FY21",  8823.0,  0.368,   0.085,  746.0,  null,    null, 348.6,    232.0),
    r("FY22", 13173.0,  0.493,   0.118, 1550.0,  null,    null, 336.2,    262.0),
    r("FY23", 16043.0,  0.218,   0.131, 2102.0,  null,    null, 332.1,    279.0),
    r("FY24", 20008.0,  0.247,   0.132, 2634.0,  null,    null, 343.4,    339.0),
    r("FY25", 21685.0,  0.084,   0.141, 3062.0,  null,    null, 341.0,    592.0),
    r("FY26", 22693.0,  0.046,   0.141, 3200.0,  41.0,131093.0, 341.0,  384.0),
  ],
  WAAREERTL: [
    ...
    r("FY24",  876.0,  1.561,   0.166,  145.0,  null,    null,  10.38,   1046.0),
    r("FY25", 1597.0,  0.823,   0.143,  229.0,  null,    null,  10.41,   1048.0),
    r("FY26", 3331.0,  1.086,   0.145,  483.0,  17.0,  8159.0,  10.43,  782.0),
  ],
  MEDANTA: [
    ...
    r("FY26",  4410.0,  0.194,  0.126,  554.0,  46.0,  25758.0,  26.8,   961.0),
