...
export const PORTFOLIO: Record<string, { qty: number; avg_cost: number; prev_close: number }> = {
...
export const TRACKER_DATA: Record<string, Row[]> = {
  POLICYBZR: [
    ...
    r("FY26E",6768.72,   0.36,      0.099,   670.1,   120.0,  80412.4,       46.3,  1608.2),
  ...
  ETERNAL: [
    ...
    r("FY26E",54656.1,   1.70,     0.0067,   366.2,  620.0, 227041.4,      965.0,   235.3),
  ...
  DIXON: [
    ...
    r("FY26E",117540.0,  1.00,    0.020,   2350.8,   80.0, 188100.0,     59.3,   31720.0),
  ...
  RELIANCE: [
    ...
    r("FY26E",1010000.0, 0.07,   0.090,  90900.0,  19.0,1727100.0,   6763.0,    2554.0),
  ...
  BHARTIARTL: [
    ...
    r("FY26E",193300.0,  0.140,  0.145,  28033.5,  25.0, 700800.0, 5690.0,    1232.0),
  ...
  MAZDOCK: [
    ...
    r("FY26E",13440.0,   0.200,  0.120,  1612.8,   28.0,  45160.0,  199.8,    2260.0),
  ...
  WAAREEENER: [
    ...
    r("FY26E",20000.0,   0.391,  0.100,  2000.0,   28.0,  56000.0,  140.4,    3989.0),
  ...
  KAYNES: [
    ...
    r("FY26E", 3220.0,   0.400,  0.100,   322.0,   80.0,  25760.0,   54.2,    4753.0),
  ...
  "M&M": [
    ...
    r("FY26E",172000.0,  0.139,  0.120,  20640.0,  27.0, 557300.0, 1240.0,   4494.0),
  ...
  IREDA: [
    ...
    r("FY26E", 11480.0,  0.400,  0.200,   2296.0,  18.0,  41330.0, 2693.5,    153.5),
