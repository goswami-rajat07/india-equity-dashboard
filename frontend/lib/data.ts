...
export const TRACKER_DATA: Record<string, Row[]> = {
  ...
  CDSL: [
    r("FY26",  1145.0,   null,   0.397,   455.0,   56.0,  25395.0,   20.85, 1218.0),
  ],
  COFORGE: [
    r("FY26", 16403.0,   null,   0.106,  1745.0,   31.0,  54065.0,   37.65, 1436.0),
  ],
  IDFCFIRSTB: [
    r("FY26", 40549.0,   null,   0.040,  1611.0,   39.0,  62300.0,  861.5,    72.4),
  ],
  JWL: [
    r("FY26",  2539.0,   null,   0.072,   182.0,   65.0,  11871.0,   42.7,   278.0),
  ],
  TECHD: [
    r("FY26",    52.0,   null,   0.269,    14.0,   33.0,    467.0,    0.748, 624.0),
  ],
  VBL: [
    r("FY26",  6574.0,   null,   0.134,   879.0,  201.0, 176996.0,  340.65, 523.0),
  ],
  WAAREERTL: [
    r("FY26",  3331.0,   null,   0.145,   483.0,   21.0,  10124.0,   10.43, 970.0),
  ],
};
